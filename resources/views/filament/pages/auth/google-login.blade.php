<x-filament-panels::page.simple>
    ...
    <x-filament-schemas::components.form id="form" wire:submit="authenticate">
        {{ $this->form }}
        ...
        {{-- Google Login Button --}}
        <a href="{{ url('/auth/google/redirect') }}" class="w-full inline-flex items-center justify-center gap-3 rounded-lg px-4 py-3 text-sm font-semibold
