    ...
    @else
        <x-filament::section>
            <div class="text-center py-12">
                ...
                <p class="text-lg font-semibold text-gray-500 dark:text-gray-400">Sertifikat Belum Terbit</p>
                <p class="text-sm text-gray-400 dark:text-gray-500 mt-1">Sertifikat akan tersedia setelah diterbitkan oleh admin.</p>
            </div>
        </x-filament::section>
    @endif
</x-filament-panels::page>
