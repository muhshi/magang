    ...
    protected function afterCreate(): void
    {
        ...
        try {
            ...
            foreach ($adminNumbers as $number) {
                WhatsappService::sendInternshipNotification(trim($number), [
                    ...
                    // 'foto_url' => $freshRecord->photo_file ? public_path("storage/{$freshRecord->letter_file}") : null,
                    // 'dokumen_url' => $freshRecord->letter_file ? public_path("storage/{$freshRecord->photo_file}") : null,
